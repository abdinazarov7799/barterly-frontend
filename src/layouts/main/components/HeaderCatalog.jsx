                        ...
                        <div className='grid grid-cols-12 gap-4'>
                            <div className='col-span-3'>
                                {categories?.map((item, index) => (
                                    <button className='flex items-center justify-between w-full py-3 px-6 hover:bg-gray' key={index}>
                                        <p>{get(item, 'label')}</p>
                            ...
                            <div className='col-span-5'>
                                ...
                                {subCategories?.map((item, index) => (
                                    <button className='flex items-center justify-between w-full py-3 pr-6 pl-24 hover:bg-gray' key={index}>
                                        <p>{get(item, 'label')}</p>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10"
                                             fill="none">
                                            <path d="M1 9L5 5L1 1" stroke="black" stroke-width="2"
