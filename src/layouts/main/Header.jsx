...
const Header = () => {
    ...
    return (
        <header className="w-full bg-gray-light relative">
            ...
            <div className="mx-auto container flex justify-between items-center py-2 font-black text-text-gray text-[12px] relative ">
            ...
            <div className="w-full bg-white py-4 relative z-50">
                <div className="mx-auto container flex justify-between items-center space-x-2">
                    <div className="flex items-center space-x-4">
                        <Link to='/'><img src={logo} alt="Logo"/></Link>
                        <button onClick={toggleCatalog} className="bg-gray p-3 rounded-md flex items-center font-extrabold text-[12px]">
                    ...
                    <div className="flex items-center space-x-4">
                        <button className="flex items-center justify-between bg-gray p-3 font-extrabold text-[12px] rounded-md ml-5">
